...
For the most premium and seamless experience, build the macOS application from source. This provides a dedicated window for your AI and handles all server management for you.
...
1.  **Clone and Build**:
    ...
    ./make_app.sh
    ```
    This creates both **`Local LLM.app`** and **`Local LLM.dmg`** in the project directory.
